                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" id="nik" name="nik">
                                        <option value="{{ $tunai->nik_kk }}">{{ $tunai->nik_kk }}|{{ $tunai->nama_kk }}
                                        </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="date" name="tanggal" placeholder="Tanggal Terima Bantuan"
                                        class="form-control" value="{{ $tunai->tgl_bantuan }}" required>
                                </div>
                                <label class="form-label col-sm-2">Keterangan</label>
                                <div class="col-sm-4">
                                    <input type="text" name="keterangan" placeholder="Keterangan" class="form-control"
                                        value="{{ $tunai->keterangan }}" required>
                                </div>
                            </div>
