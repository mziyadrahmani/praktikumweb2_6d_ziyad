                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="nik" class="form-control" value="{{ $data->nik_kk }}"
                                    readonly>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="jeniskelamin" class="form-control"
                                value="{{ $data->jeniskelamin_kk }}" readonly>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input type="date" name="tgllahir" placeholder="Tanggal Lahir" class="form-control"
                                value="{{ $data->tgllahir_kk }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="pendidikan" class="form-control"
                                    value="{{ $data->pendidikan_kk }}" readonly>
                            </div>
                        </div>
                        <label class="form-label col-sm-2">Pekerjaan</label>
                        <div class="col-sm-4">
                            <input type="text" name="pekerjaan" class="form-control" value="{{ $data->pekerjaan_kk }}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="penghasilan" class="form-control"
                                    value="{{ $data->penghasilan_kk }}" readonly>
                            </div>
                        </div>
                        <label class="form-label col-sm-2">Alamat</label>
                        <div class="col-sm-4">
                            <input type="text" name="alamat" class="form-control" value="{{ $data->alamat_kk }}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="create" class="form-control" value="{{ $data->created_at }}"
                                    readonly>
                            </div>
                        </div>
                        <label class="form-label col-sm-2">Updated_at</label>
                        <div class="col-sm-4">
                            <input type="text" name="update" class="form-control" value="{{ $data->updated_at }}"
                                readonly>
                        </div>
                    </div>
