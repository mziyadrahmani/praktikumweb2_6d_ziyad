<!--Menghubungkandenganviewtemplatemaster-->
@extends('template.master')
<!--isibagianjudulhalaman-->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="basic example">
                                    <a
                                        href="{{ route('penduduk.show', $data->nik_kk) }}"class="btn btn-small btn-secondary">Detail</a>
                                    <a
                                        href="{{ route('penduduk.edit', $data->nik_kk) }}"class="btn btn-small btn-warning">Edit</a>
                                    <form action="{{ route('penduduk.destroy', $data->nik_kk) }}"method="POST"
