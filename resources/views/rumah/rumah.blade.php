...
@section('konten')
    ...
    <a href="{{ route('cetakRumah') }}" type="button" class="btn btn-info">Cetak Laporan</a>
    <hr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="basic example">
                                    <a
                                        href="{{ route('rumah.show', $data->id) }}"class="btn btn-small btn-secondary">Detail</a>
                                    <a
                                        href="{{ route('rumah.edit', $data->id) }}"class="btn btn-small btn-warning">Edit</a>
