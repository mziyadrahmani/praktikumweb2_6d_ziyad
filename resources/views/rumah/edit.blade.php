...
@section('judul_halaman', 'UBAH DATA BANTUAN BEDAH RUMAH')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" id="nik" name="nik">
                                        <option value="{{ $rumah->nik_kk }}">{{ $rumah->nik_kk }}|{{ $rumah->nama_kk }}
                                        </option @foreach ($penduduks as $penduduk)
                                        >
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="date" name="tanggal" placeholder="Tanggal Terima Bantuan" class="form-control"
                        value="{{ $rumah->tgl_bantuan }}" required>
                </div>
                <label class="form-label col-sm-2">Keterangan</label>
                <div class="col-sm-4">
                    <input type="text" name="keterangan" placeholder="Keterangan" class="form-control"
                        value="{{ $rumah->keterangan }}" required>
                </div>
            </div>
